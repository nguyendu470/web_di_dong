<?php
    ...
    AND tbl_sanpham.category_id='$id' ORDER BY tbl_sanpham.time ASC LIMIT $begin,8");
    ...
    AND tbl_sanpham.category_id='$id' ORDER BY tbl_sanpham.time ASC");
...
<div class="body-product-list" >
    <h2 class="heading_title" >
      ...
      <p class="heading_title"> sản phẩm "Cũ Nhất"</p>
