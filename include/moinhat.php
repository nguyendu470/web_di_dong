<?php
    ...
    AND tbl_sanpham.category_id='$id' ORDER BY tbl_sanpham.time DESC LIMIT $begin,8");
    ...
    AND tbl_sanpham.category_id='$id' ORDER BY tbl_sanpham.time DESC");
...
<div class="body-product-list" >
    <h2 class="heading_title" >
      ...
      <p class="heading_title"> sản phẩm "Mới Nhất"</p>
